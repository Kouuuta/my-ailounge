...
1. **`INSTRUCTIONS.md`** — Set up your dev environment (GitHub Copilot, opencode CLI, Gemini CLI).
...
7. **`developer-dashboard.md`** — Read the dashboard spec (modules, audiences, requirements).
8. **`feeds/feeds-format-guide.md`** — Learn the markdown feed format for manual entries.
9. **`agentic-coding-attribute-matrix.md`** — Understand AI coding patterns used in this repo.
...
| Doc | Description |
|-----|-------------|
| `INSTRUCTIONS.md` | Full developer onboarding: GitHub Copilot, opencode CLI, Gemini CLI, model selection, troubleshooting |
| `AI-installation-tutorial.md` | Quick 10-minute setup for opencode and Gemini CLI tools |
| `WARP.md` | Warp.dev terminal integration and agent workflow guidance |
...
| `File architecture update.md` | Repository folder reorganization plan and execution guide |
| `agentic-coding-attribute-matrix.md` | AI coding patterns and attributes used in the repo |
| `RnD_Technical_Tasks_Overview.md` | R&D technical task inventory and planning overview |
...
| Doc | Description |
|-----|-------------|
| `developer-dashboard.md` | Dashboard requirements specification: 3 audiences (lead devs, interns, team), 8 modules with feature descriptions, non-binding stack suggestions |
...
> No dedicated watchlist feature guide exists yet. See `documentation-audit-v2.md` for the gap.
...
| Doc | Description |
|-----|-------------|
| `oh-my-opencode-models.md` | Agent role definitions and model selection guide for opencode (Sisyphus, Architect, etc.) |
| `reference-prompts.md` | Curated prompts for AI agents in Django/DRF/Celery workflows |
| `CONTEXT-ENGINEERING.md` | Principles and practices for designing AI-readable documentation and repository context |
...
| Doc | Description |
|-----|-------------|
| `research.md` | Research opportunities, tools, articles, and best practices for AI development |
| `pricing.md` | AI model pricing comparisons and cost analysis |
| `deepseek-gemini-claude-comparison.md` | Model capability comparison across DeepSeek, Gemini, and Claude |
| `vibe-coding-vs-legacy.md` | Analysis of AI-assisted coding vs traditional development approaches |
...
| Doc | Description |
|-----|-------------|
| `documentation-audit.md` | Original documentation audit: full inventory of features, pages, API routes, database tables, analytics, widgets, ingestion system, watchlist system, missing documentation |
| `documentation-audit-v2.md` | Re-evaluated audit after creation of `src/*/README.md` files: updated statuses, covered gaps, duplicate recommendations removed |
| `documentation-roadmap.md` | Prioritized documentation production plan: 12 proposed docs grouped by priority, with dependencies and implementation phases |
...
| **UI pages** (`app/`, `components/`) | `docs/` with a descriptive name (e.g., `docs/feed-page.md`) |
| **API routes** (`app/api/`) | `docs/api/` (e.g., `docs/api/api-reference.md`) |
| **Features** (watchlist, theme, dashboard widgets) | `docs/<feature-name>.md` |
| **Deployment or operations** | `docs/deployment.md` |
...
| **Research, comparisons, evaluations** | `docs/` with a descriptive name |
| **AI prompts, model guides, context engineering** | `docs/` (e.g., `docs/oh-my-opencode-models.md`) |
| **Documentation audits and roadmaps** | `docs/` with a `documentation-<topic>.md` prefix |
